			...
			buttons : {
				"添加" : function(e) {
					...
					updateOrder(true, function(data) {
						...
						// alert("添加失败了");
						// 信息显示
						showMessage("新增订单", data.msg, false);
						// $("#dialog-order-form").dialog("close");
					});
				},
				"取消" : function() {
													...
													if (targetOrder) {
														...
														$("#input-orderId2")
																.val(
																		targetOrder.orderId);
														$(
																"#input-orderClientname2")
																.val(
																		targetOrder.orderClientname);
														$(
																"#input-orderProductname2")
																.val(
																		targetOrder.orderProductname);
														$(
																"#input-orderContractid2")
																.val(
																		targetOrder.orderContractid);
														$("#input-orderImgid2")
																.val(
																		targetOrder.orderImgid);
														$(
																"#input-orderMaterialname2")
																.val(
																		targetOrder.orderMaterialname);
														$(
																"#input-orderCometime2")
																.val(
																		targetOrder.orderCometime);
														$(
																"#input-orderCommittime2")
																.val(
																		targetOrder.orderCommittime);
														$(
																"#input-orderInventorystatus2")
																.val(
																		targetOrder.orderInventorystatus);
														$(
																"#input-orderSalestatus2")
																.val(
																		targetOrder.orderSalestatus);
														$(
																"#input-orderMaterialsource2")
																.val(
																		targetOrder.orderMaterialsource);
														$(
																"#input-orderHurrystatus2")
																.val(
																		targetOrder.orderHurrystatus);
														$("#input-orderStatus2")
																.val(
																		targetOrder.orderStatus);
														$("#input-orderRemark2")
																.val(
																		targetOrder.orderRemark);
														// ///////////////////////////////////////////////////////////////
													}
												},
												buttons : {
